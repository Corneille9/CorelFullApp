package com.corel.corelfullapp.dao;
...
public class ProductDao {
    ...
    public Product getOne(int id){
        ...
        Cursor cursor = database.query(Product.TABLE_NAME, column, where, whereArgs , "", "","");
    ...
    public List<Product> findAll(){
        ...
        Cursor cursor = database.query(Product.TABLE_NAME, column, "", null, "", "","");
        if(cursor!=null) {
