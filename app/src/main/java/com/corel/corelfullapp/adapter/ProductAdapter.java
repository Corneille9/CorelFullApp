package com.corel.corelfullapp.adapter;
...
public class ProductAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        @SuppressLint("ViewHolder") ConstraintLayout myView = (ConstraintLayout) LayoutInflater.from(context).inflate(R.layout.regular_product_item, viewGroup, false);
